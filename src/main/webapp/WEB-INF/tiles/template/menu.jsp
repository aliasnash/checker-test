				...
				<div class="side-menu-container">
					<ul class="nav navbar-nav">
						...
						<li class="${pageName eq 'goods' ? 'active' : ''}">
							...
							<a href="${pageName eq 'goods' ? '#' : goodsUrl}">
						...
						<li class="${pageName eq 'check' ? 'active' : ''}">
							...
							<a href="${pageName eq 'check' ? '#' : checkUrl}">
								<span class="glyphicon glyphicon-camera"></span>
								Проверка
							</a>
						</li>
						<li class="${pageName eq 'tasks' ? 'active' : ''}">
							...
							<a href="${pageName eq 'tasks' ? '#' : tasksUrl}">
						...
						<li class="${pageName eq 'chains' ? 'active' : ''}">
							...
							<a href="${pageName eq 'chains' ? '#' : chainsUrl}">
						...
						<li class="${pageName eq 'category' ? 'active' : ''}">
							...
							<a href="${pageName eq 'category' ? '#' : categoriesUrl}">
