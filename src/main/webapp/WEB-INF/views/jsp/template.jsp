		...
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				...
				<span class="pull-right">
					<a class="btn btn-default collapse-button collapsed" href="#filter-template-build" data-toggle="collapse" aria-expanded="true"> <span
					...
					<div class="modal-body">
						<div class="row">
							<div class="form-group col-md-3">
								...
								<div class="col-md-12">
									<input readonly="readonly" name="filtered_template_date" maxlength="50" class="form-control" id="date" placeholder="ГГГГ-ММ-ДД" value="${templateDate}"
										type="text">
								</div>
							</div>
							<div class="form-group col-md-3">
						...
						<tr>
							...
							<th class="text-right col-md-3">
								<a data-element-id="" data-element-name="" data-toggle="modal" data-target="#modal-edit-template" class="btn btn-sm btn-success"> <span
										class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> &nbsp;Шаблон
								</a>
								<spring:url value="/template/file/add/form" var="addTemplateFileUrl" htmlEscape="true" />
								<a class="btn btn-sm btn-success" href="${addTemplateFileUrl}"> <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> &nbsp;Файл
								</a>
							</th>
						</tr>
					</thead>
								...
								<td>
									<div class="btn-group pull-right" role="group" aria-label="...">
										...
										<a class=" btn btn-sm btn-default" href="${templateUrl}"> <span class="glyphicon glyphicon-list" aria-hidden="true"></span> Артикулы
											...
											data-element-file="${template.fileName}" data-element-idcity="${template.idCity}" data-toggle="modal"
											data-target="#modal-edit-template" class=" btn btn-sm btn-primary"> <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
										</a>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form class="form-horizontal" role="form" action="<spring:url value="/template/update?page=${page}" htmlEscape="true" />" method="post">
								...
								<input value="" name="idcity-template-filtered" type="hidden">
